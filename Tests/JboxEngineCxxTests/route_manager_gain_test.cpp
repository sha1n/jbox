// route_manager_gain_test.cpp — Task 5 of the Route Gain + Mixer-Strip
// implementation plan.
//
// Verifies that `outputIOProcCallback` applies the smoothed master *
// trim per-channel gain to converted samples before writing them to
// the destination buffer. Behaviours pinned here:
//
...
//
// Tagged `[route_gain]` so all of the above can be filtered with
